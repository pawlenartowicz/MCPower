...
def main(argv):
    ...
    parser.add_argument("--scale", type=float, default=1.0,
                        help="Scale every tier's sim count (0.1 = 10%% sims, a quick preview)")
    args = parser.parse_args(argv)

    # Sim-count scale for this run; scaled_sims() and build_meta() read this
    # module global. 0.1 = a 10%-sims quick preview — combine.py normalizes
    # per-sim so ratios stay honest, and meta records the scale.
    global N_SIMS_SCALE
    N_SIMS_SCALE = args.scale
