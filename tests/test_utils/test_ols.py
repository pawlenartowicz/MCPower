...
class TestCorrections:
    ...
    def test_bonferroni_correction(self):
        ...
        n = 100
        X = np.random.normal(0, 1, (n, 3))
        y = 0.5*X[:, 0] + np.random.normal(0, 0.5, n)  # Only first predictor has effect
...
class TestGenerateY:
    ...
    def test_basic_y_generation(self):
        ...
        y = _generate_y(X, effect_sizes, heterogeneity=0.0, heteroskedasticity=0.0, sim_seed=42)
    ...
    def test_heterogeneity(self):
        ...
        y1 = _generate_y(X, effect_sizes, heterogeneity=0.0, heteroskedasticity=0.0, sim_seed=42)
        y2 = _generate_y(X, effect_sizes, heterogeneity=0.3, heteroskedasticity=0.0, sim_seed=42)
    ...
    def test_heteroskedasticity(self):
        ...
        y1 = _generate_y(X, effect_sizes, heterogeneity=0.0, heteroskedasticity=0.0, sim_seed=42)
        y2 = _generate_y(X, effect_sizes, heterogeneity=0.0, heteroskedasticity=0.3, sim_seed=42)
    ...
    def test_reproducibility(self):
        ...
        y1 = _generate_y(X, effect_sizes, heterogeneity=0.1, heteroskedasticity=0.1, sim_seed=123)
        y2 = _generate_y(X, effect_sizes, heterogeneity=0.1, heteroskedasticity=0.1, sim_seed=123)
...
class TestStatisticalAccuracy:
    ...
    def test_different_alpha_levels(self):
        ...
        # Test stricter alpha
        results_strict = _ols_analysis(X, y, target_indices, correction_method=0, alpha=0.01)
        results_lenient = _ols_analysis(X, y, target_indices, correction_method=0, alpha=0.10)
