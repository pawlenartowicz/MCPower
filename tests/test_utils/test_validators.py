...
class TestCorrelationMatrixValidation:
    ...
    def test_valid_matrix_3x3(self):
        ...
        matrix = np.array([[1.0, 0.3, 0.5], [0.3, 1.0, 0.2], [0.5, 0.2, 1.0]])
        result = _validate_correlation_matrix(matrix)
        assert result.is_valid is True
    ...
    def test_singular_matrix(self):
        ...
        matrix = np.array(
            [[1.0, 0.99999, 0.99999], [0.99999, 1.0, 0.99999], [0.99999, 0.99999, 1.0]]
        )
        result = _validate_correlation_matrix(matrix)
...
class TestTestFormulaValidation:
    ...
    def test_valid_formula(self):
        ...
        valid_formulas = ["x1 + x2", "x1:x2", "x1 * x2", "x1 + x2 + x1:x2"]
...
class TestValidatorEdgeCases:
    ...
    def test_correlation_matrix_tolerance(self):
        ...
        matrix = np.array([[1.0, 0.5000000001], [0.5, 1.0]])
        result = _validate_correlation_matrix(matrix)
