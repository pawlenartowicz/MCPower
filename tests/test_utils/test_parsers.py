...
from mcpower.utils.parsers import (
    _parse_equation, _parse_independent_variables, 
    _validate_and_parse_effects, _parser
)
...
class TestAssignmentParser:
    ...
    def test_variable_type_parsing(self):
        ...
        parsed, errors = _parser._parse("x1=binary, x2=normal", 'variable_type', ['x1', 'x2'])
    ...
    def test_binary_with_proportion(self):
        ...
        parsed, errors = _parser._parse("treatment=(binary,0.3)", 'variable_type', ['treatment'])
    ...
    def test_correlation_parsing(self):
        ...
        parsed, errors = _parser._parse("corr(x1,x2)=0.5, corr(x1,x3)=-0.3", 'correlation', ['x1', 'x2', 'x3'])
    ...
    def test_parentheses_splitting(self):
        ...
        assignments = _parser._split_assignments("x1=binary, x2=(binary,0.3), x3=normal")
    ...
    def test_invalid_effects(self):
        ...
        with pytest.raises(ValueError, match="Validation failed"):
            _validate_and_parse_effects(
                "unknown=0.5", available_effects, "effect"
            )
...
class TestVariableTypeValues:
    ...
    def test_all_supported_types(self):
        ...
        types = ['normal', 'binary', 'right_skewed', 'left_skewed', 'high_kurtosis', 'uniform']
...
class TestCorrelationAssignmentParsing:
    ...
    def test_invalid_correlation_format(self):
        ...
        with pytest.raises(ValueError):
            _parser._parse_correlation_assignment("corr(x1)=0.5")  # Missing second variable
        
        with pytest.raises(ValueError):
            _parser._parse_correlation_assignment("corr(x1, x2, x3)=0.5")  # Too many variables
...
class TestEdgeCases:
    ...
    def test_complex_interaction_formula(self):
        ...
        variables, effects = _parse_independent_variables("a + b + c + a:b + a:c + b:c + a:b:c")
    ...
    def test_mixed_assignment_types(self):
        ...
        parsed, errors = _parser._parse("x1=0.5, invalid, x2=0.3", 'effect', ['x1', 'x2'])
