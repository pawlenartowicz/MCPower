---
title: "MCPower Validation — How Correctness Is Proved"
description: "How MCPower validates simulation-based power analysis - split-pipeline correctness, data generation fidelity, and solver agreement with R."
right_sidebar: body
---
# Validation
...
| [Agreement with other tools](validation_tool_agreement.md) | an informal cross-check — MCPower's power lands on the same answer as the dedicated R tools (`simglm`, `simr`) and an independent DIY loop |
