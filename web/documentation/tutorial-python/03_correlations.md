---
title: "Correlated Predictors & Power Analysis - Python"
description: "How correlated predictors reduce statistical power: model realistic joint predictor distributions in Python with MCPower for accurate sample size estimates."
---
# Correlations
...
MCPower accepts predictor correlations in three equivalent forms. Pick whichever
fits your workflow.
...
Pass a matrix — a plain list of lists (or a numpy array, if you have numpy
installed) — whose rows and columns follow the predictor order in the formula
...
If you would rather keep correlations as Python data, pass a dict keyed by
variable-name pairs. It is exactly equivalent to the string form, so it produces
the same result:
