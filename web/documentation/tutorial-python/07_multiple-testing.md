---
title: "Multiple Testing Correction & Power - Python"
description: "How multiple testing corrections (Bonferroni etc.) affect power in Python with MCPower: compare corrected vs uncorrected power across a panel of predictors."
---
# Multiple testing
...
model = MCPower("response = biomarker1 + biomarker2 + biomarker3")
