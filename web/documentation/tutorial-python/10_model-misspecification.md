---
title: "Model Misspecification & Power - Python"
description: "Quantify the power cost of misspecifying your analysis model in Python with MCPower: use test_formula to fit a different model from the data-generating process."
---
