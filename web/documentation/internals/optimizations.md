---
title: "MCPower engine: fast, parallel & reproducible"
description: "How MCPower delivers simulation-based power analysis across all CPU cores, with a reproducible random stream and smooth sample-size search via Grid."
---
