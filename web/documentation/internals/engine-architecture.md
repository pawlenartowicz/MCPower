---
title: "MCPower engine: one engine, four ports"
description: "How MCPower runs the same compiled Rust engine in Python, R, a desktop app, and the browser, and how results stay consistent across all four."
---
