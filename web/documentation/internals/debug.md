---
title: "MCPower R debug mode: inspect the simulation pipeline"
description: "How to use MCPowerDebug in R to inspect generated data, model dispatch, test statistics, and critical values for any power analysis scenario."
---
# Debug mode (R)
