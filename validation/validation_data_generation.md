...
| `y ~ g1*g2` | `g1=0.50, g2[2]=0.40, g1:g2[2]=0.30` | 800 | all OK | all OK | yes |
| `y ~ g1*g2` | `g1=0.20, g2[2]=0.80, g1:g2[2]=0.50` | 800 | all OK | all OK | yes |
...
## y = 0.5·g1 + 0.4·g2\[2\] + 0.3·g1:g2\[2\] + noise
...
| What we check        | Requested | Average over draws | Allowed difference | Result |
|:---------------------|----------:|-------------------:|:-------------------|:-------|
| average of g1        |         0 |             0.0014 | within 0.01        | OK     |
| std. deviation of g1 |         1 |             1.0000 | within 0.01        | OK     |
...
| Term | True value | Recovered (average) | Spread across draws | Std. errors from true | Result |
|:---|---:|---:|---:|---:|:---|
| intercept | 0.0 | 0.0013 | 0.0458 | 1.1304 | OK |
| g1 | 0.5 | 0.5000 | 0.0464 | -0.0370 | OK |
| g2\[2\] | 0.4 | 0.4007 | 0.0731 | 0.3740 | OK |
| g1:g2\[2\] | 0.3 | 0.2973 | 0.0731 | -1.4814 | OK |
...
## y = 0.2·g1 + 0.8·g2\[2\] + 0.5·g1:g2\[2\] + noise
...
| Term | True value | Recovered (average) | Spread across draws | Std. errors from true | Result |
|:---|---:|---:|---:|---:|:---|
| intercept | 0.0 | 0.0010 | 0.0466 | 0.8659 | OK |
| g1 | 0.2 | 0.1995 | 0.0494 | -0.3743 | OK |
| g2\[2\] | 0.8 | 0.8013 | 0.0693 | 0.7655 | OK |
| g1:g2\[2\] | 0.5 | 0.4987 | 0.0733 | -0.7328 | OK |
