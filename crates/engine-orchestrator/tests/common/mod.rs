...
use engine_contract::{
    ...
    ScenarioPerturbations, SimulationContract, SyntheticKind, TestSpec, TestTarget,
};

use engine_spec_builder::{
    EffectAssignment, HeteroskedasticityInput, LinearSpec,
    PredictorSpec, ResidualSpec as BuilderResidualSpec, VarKind,
};
