...
/// cover their own slice). Catches:
///   * factor proportion sum / positivity / level count
///   * factor reference level present in `levels`
///   * binary proportion in [0,1]
