...
fn scenario_heterogeneity_alone_perturbs_y() {
    ...
    assert_eq!(x_a, x_b, "X stream must not depend on scenario heterogeneity");
    assert_eq!(r_a, r_b, "residual stream must not depend on scenario heterogeneity");
...
fn binary_jitter_fires_for_scenario_heterogeneity() {
    ...
    assert_eq!(x_a, x_b, "X stream must not depend on scenario heterogeneity");
    assert_eq!(u_a, u_b, "uniform stream must not depend on scenario heterogeneity");
