...
//! discipline for an eventual standalone synthetic-data library. The output
//! stream is part of the reproducibility contract — the KAT below pins the
//! algorithm; `golden_rng.rs` pins the derived draws.
//!
