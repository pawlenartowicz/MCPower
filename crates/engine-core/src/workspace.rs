...
impl SimWorkspace {
    ...
    pub fn new(
        ...
        let max_n_clusters = cluster
            .map(|c| c.sizing.n_clusters_at(max_n))
            .unwrap_or(0);
        ...
        Self {
            ...
            panel_x: vec![0.0f64; crate::ols::PANEL_ROWS * n_predictors],
            panel_y: vec![0.0f64; crate::ols::PANEL_ROWS],
            ...
            extra_grouping_ids: (0..n_extras)
                .map(|g| {
                    ...
                    (0..max_n).map(|i| c.extra_level_of_row(g, i) as u32).collect()
                })
                .collect(),
...
mod tests {
    ...
    fn workspace_allocates_with_correct_shapes() {
        let ws = SimWorkspace::new(
            ...
            3,
            2,
            Some(&engine_contract::ClusterSpec::intercept_only(ClusterSizing::FixedClusters { n_clusters: 20 }, 0.25)),
        );
        ...
        assert_eq!(ws.panel_x.len(), crate::ols::PANEL_ROWS * 5);
        assert_eq!(ws.panel_y.len(), crate::ols::PANEL_ROWS);
    ...
    fn extra_grouping_buffers_sized_and_laid_out() {
        ...
        for i in 0..24 {
            assert_eq!(ws.extra_grouping_ids[0][i], spec.extra_level_of_row(0, i) as u32);
            assert_eq!(ws.extra_grouping_ids[1][i], spec.extra_level_of_row(1, i) as u32);
        }
