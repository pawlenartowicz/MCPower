...
pub use spec::{
    ...
    EngineError, EstimatorSpec, LmeScenarioPerturbations, OutcomeKind,
    PosthocBlockShape, PosthocSpec, ProgressSink, ResidualDist, ResultShape, ScenarioPerturbations,
    SimulationSpec,
};
