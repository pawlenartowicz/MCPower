...
# results.py _factor_label — render the display label for a factor dummy
...
# results.py _render_descriptor — render one EffectDescriptor from the
...
# results.py build_rows — ordered display rows from the engine's
