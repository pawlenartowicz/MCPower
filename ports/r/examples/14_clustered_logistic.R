# Clustered Logistic (GLMM) Example
# =================================
#
# Power for a clustered binary outcome — a logistic GLMM. Combine
# family = "logit" with a (1|group) term and set_cluster(ICC, n_clusters): the
# engine fits a random-intercept logistic model (Laplace approximation) so the
# within-cluster correlation is accounted for on the log-odds scale.
#
