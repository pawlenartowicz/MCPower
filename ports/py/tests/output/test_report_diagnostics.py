...
# ---------------------------------------------------------------------------
# Task 3: _check_result_failure_threshold None-guard (model.py)
# ---------------------------------------------------------------------------
...
def test_check_result_failure_threshold_none_cr_returns_without_raising():
    ...
    returns silently — the OLS / non-LME no-op guard (model.py)."""
...
# ---------------------------------------------------------------------------
# GLM baseline drift → live gate against the requested baseline.
# ---------------------------------------------------------------------------
