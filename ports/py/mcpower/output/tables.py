...
# power and target columns directly; CI goes to the long-form section).
...
def main_power_tables(scenarios, meta, *, dec, tdec, target, caption):
    ...
    No CI column, no ✓/✗, no Δ column (drop moved to the long-form diagnostics section). caption is the base
